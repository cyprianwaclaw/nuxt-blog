<template>
  <div class="w-[300px] mx-auto my-auto cursor-default">
    ...
    <Form @submit="login" @click="auth.nullError()">
      <div class="flex flex-col gap-[16px] mb-7">
        ...
        <div class="flex justify-end -mt-1">
          <p class="font-base text-[13px] text-open" @click="$emit('componentPassword')">
            Nie pamiętam hasła
          </p>
        </div>
      </div>
    ...
    <div class="flex gap-[6px] justify-center mt-8">
      ...
      <p class="font-medium text-[14px] text-open" @click="$emit('componentRegister')">
        Zarejestruj się
      </p>
    </div>
  </div>
